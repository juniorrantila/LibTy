...
{
    switch (mime_type()) {
    case MimeType::ApplicationJson: return "utf-8"sv;
    case MimeType::ApplicationOctetStream: return ""sv;
    case MimeType::ImageIco: return ""sv;
    case MimeType::ImagePng: return ""sv;
    case MimeType::TextCss: return "utf-8"sv;
    case MimeType::TextHtml: return "utf-8"sv;
    case MimeType::TextJavascript: return "utf-8"sv;
    case MimeType::TextMarkdown: return "utf-8"sv;
    case MimeType::TextPlain: return "utf-8"sv;
    }
}
